...
public class PlatformElement extends MovingElement {
	/**
	 * Stores elements for platform in an array list usedElms
	 */
	private ArrayList<AbstractElement> usedElms;
	/**
	 * Max position for up and to the right
	 */
	private double max;
	/**
	 * Max position for down and to the left
	 */
	private double min;
	...
	public PlatformElement(double x, double y, int width, int height) {
		...
		usedElms = new ArrayList<AbstractElement>();
		max = Double.POSITIVE_INFINITY;
		min = Double.NEGATIVE_INFINITY;
	}

	/**
	 * Adds objects attached to the platform to the array list
	 * 
	 * @param attached
	 */
	public void addAssociated(AttachedElement attached) {
		usedElms.add(attached);
	...
	public void addAssociated(FollowerElement follower) {
		usedElms.add(follower);
		follower.setBase(this);
	}

	/**
	 * Removes objects that have been deleted
	 */
	public void deleteMarkedAssociated() {
		ArrayList<AbstractElement> toRemove = new ArrayList<>();
		for (AbstractElement associated : usedElms) {
			if (associated.isMarked()) {
				toRemove.add(associated);
			}
		}
		this.usedElms.removeAll(toRemove);
	}

	/**
	 * Gets max position for up and to the right
	 * 
	 * @return max
	 */
	...
	/**
	 * Gets max position for down and to the left
	 * 
	 * @return min
	 */
	...
	/**
	 * Gets array list of all used objects
	 * 
